---
name: "The Flooded Crown"
title: "The Flooded Crown"
slug: the-flooded-crown
type: session
session_number: 3
played: 2026-08-27
players_present: [Rob, Morgan, Nathan, David]
origin: merged
tags: [world-merge, briarwood-mall, blood-bowl, color-game, long-term-projects]
created: 2026-09-03
updated: 2026-09-03
...
Downtime first. [Geezus](../world/people/sesug-tsirch.md) and
[Mitch Saddlerash](../world/people/mitch-saddlerash.md) preached to the mall
that [Phil Bernard](../world/people/phil-bernard.md)'s kingship carries
divine right, and the party spent the stretch settling
[Briarwood Mall](../world/places/briarwood-mall.md) on its first real set of
norms and customs — definitely, and canonically, not evil, hopefully.
[Jack Mercer](../world/people/jack-mercer.md) finished two long-term
projects: [The R2 Rig](../items/r2-rig.md), splint armor built up with
enough salvaged instruments that the table immediately started comparing
him to a very large astromech droid, and
[Jack's Spectrometer](../items/jacks-spectrometer.md), built to detect
radiation outside the visible spectrum. Phil worked at actually being a
good king rather than just holding the title, and started winning over a
few skeptical locals.

The next morning, [Agent](../world/npcs/agent.md) appeared — visibly
...
behind them. From the dance studio, Jack found the **Ultraviolet** token —
a bug zapper. The party then made for an apartment building lit up in neon
— and there met **the Queen of Scornubel**: [Miriel Ashgrove](../world/npcs/miriel-ashgrove.md),
pressed into the crown by the Coster Council on an hour's notice and
plainly unhappy about it. The party's first real meeting with her went
well.
...
- [The R2 Rig](../items/r2-rig.md) — Jack Mercer, completed as a long-term
  project.
- [Jack's Spectrometer](../items/jacks-spectrometer.md) — Jack Mercer,
  completed as a long-term project.

## DM Only

**Long-term projects.** This table is running Blades in the Dark-style
downtime projects between sessions — worth tracking consistently going
forward, since Jack's two completions this session (armor + detection
tool) both had immediate, real mechanical payoff at the table rather than
staying flavor-only. Expect other PCs' projects to matter the same way once
they land.

**Session numbering note.** Filed as Session 3, following directly from
[Session 2](02-the-mall-king.md)'s in-fiction "next morning" — real-world
play happened weeks apart (Aug 8 to Aug 27), but nothing in the fiction
implies a gap.
